 function generateParagraph() {
            ...
            if (districtType == 'transport' && typology == 'high density'){
                ...
                var length = [Math.floor(Math.random() * 230 + 10 )];
                 ...
                 buildVolume = ['site size that has a total area of ' + length + ' meters length, by ' + width + ' meters width, with a height of ' + height + ' meters'];

                    if (buildType == 'skyscraper'){
                        buildVolume = ['site size with a square base of ' + length + ' meters, with a height of ' + height + ' meters'];
                    }
